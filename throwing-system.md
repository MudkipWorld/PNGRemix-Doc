...
**Parameters:**
- `item_name` (string): Name of the chosen throwable item.
- `amount` (number): The amount of thrown items.
- `variance` (number): Throw position/ angle variance.
- `both_sides` (bool): If the item should be thrown from the opposite side too.
- `pause` (bool): Pauses the throwing system.


**Requests:**
```json
{"event": "throw_item", "item_name": "Banana", "amount": 10, "variance": 60, "both_sides": false}

{"event": "throw_random", "amount": 10, "variance": 60, "both_sides": false}

{"event": "toggle_throwables_pause", "pause": true}

```

**Success Responses:**
```json
{"event": "throw_item", "result": "success", "item_name": item_name, "amount": amount}

{"event": "throw_random", "result": "success"}

{"event": "toggle_throwables_pause", "result": "success", "is_paused": new_state}
...
![ThrowingPreview1](assets/Tutorial_image_23.png)
![ThrowingPreview2](assets/Tutorial_image_24.png)